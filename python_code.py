...
csvfile=open('results_task1.csv', 'wb') 
fieldnames = ['System_Name', 'Method','Filename','Precision_Task_1a','Recall_Task_1a','F1_Score_Task_1a','Precision_Task_1b','Recall_Task_1b','F1_Score_Task_1b']
    ...
    if systems!="Gold" and systems!="System3":
        for runs in os.listdir(folder_read+systems):
            ...
            for files in dict_gold :
              if  (system_name=="System13->Default" and files=="P05-1053"):
                  print "No"
              else :
